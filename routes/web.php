...
Route::group(['middleware' => 'IsAdmin'], function () {
  ...
  //navigation_start
  Route::get('show-all-navigation_section', 'HomepageContentController@show_all_navigation_section')->name('show-all-navigation_section');
  Route::get('add-navigation-section', 'HomepageContentController@add_navigation_section_ui');
  Route::post('add-navigation-section', 'HomepageContentController@add_navigation_section')->name('add-navigation-section');
  Route::get('navigation-section_active_status_update/{id}', 'HomepageContentController@navigation_section_active_status_update');
  Route::get('edit_navigation-section_content/{id}', 'HomepageContentController@edit_navigation_section_content_ui')->name('edit_navigation-section_content');
  Route::post('update_navigation-section_content', 'HomepageContentController@update_navigation_section_content')->name('update_navigation-section_content');
  Route::get('navigation-section_content_delete/{id}', 'HomepageContentController@navigation_section_content_delete')->name('navigation-section_content_delete');
  Route::get('edit_navigation-section_image/{id}', 'HomepageContentController@edit_navigation_section_image_ui')->name('edit_navigation-section_image');
  Route::post('update_navigation-section_image', 'HomepageContentController@update_navigation_section_image')->name('update_navigation-section_image');
  Route::post('update_navigation_content_order', 'HomepageContentController@update_navigation_content_order')->name('update_navigation_content_order');
  Route::get('change_retailer_priority/{id}', 'HomepageContentController@change_retailer_priority')->name('change_retailer_priority');
  Route::post('update_retailer_order', 'HomepageContentController@update_retailer_order')->name('update_retailer_order');
  //navigation_end
